        ...
        <div id="Table" className="fixed inset-0 flex items-center justify-center bg-white z-10">
          <div className="grid grid-cols-4 gap-4">
            ...
            {providers.map((
              ...
              provider, index) => (
                // @ts-ignore
              <div key={index} className="flex flex-col items-center p-4" onClick={function(){document.getElementById("Table")?.classList.add("hidden"); document.getElementById(provider.providerId).checked = true}}>
